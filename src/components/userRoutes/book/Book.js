...
import {  EyeOutlined ,DownloadOutlined,RollbackOutlined } from '@ant-design/icons';
    ...
    <div>
          ...
          <Card
            ...
            actions={[
              ...
              <DownloadOutlined  onClick={() => empruntBook(id,userId)} />,
  ...
  return (
    <div>
          ...
          <Card
            ...
            actions={[
              <RollbackOutlined  onClick={() => empruntBook(id,userId)}/>,
              <EyeOutlined onClick={showModal} />,
