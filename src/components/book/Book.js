...
import { Card ,Modal,Button,Switch,Popconfirm} from 'antd';
          ...
          <Card
            ...
            >
              ...
              <p> <strong>Edition : </strong> {edition}</p>
               {archiver==="oui" ? (
                <p> <strong>Archiver  : </strong> <Switch defaultChecked  onChange={onChange} /> </p>
               ) : (
                <p> <strong>Archiver  : </strong> <Switch onChange={onChange} /> </p>
               )}
